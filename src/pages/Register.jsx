...
import { registerTeacher, clearError } from '../store/slices/authSlice';
...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    registerData.subjectSpecialization = registerData.subjectSpecialization.split(',').map(s => s.trim());
    
    dispatch(registerTeacher(registerData));
  };
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join as a teacher</p>
          </div>
